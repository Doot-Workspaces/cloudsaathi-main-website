...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'The percentage component ensures we scale with you. As your infrastructure grows, so does the complexity we manage. The flat base covers our operational cost; the percentage ensures we\u2019re investing proportionally in your success. For example, at $20K/mo cloud spend, Silver is $899/mo and Gold is $1,599/mo - a fraction of a full-time hire.',
  },
  {
